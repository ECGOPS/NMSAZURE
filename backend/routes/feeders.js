...
router.post('/', requireRole(['system_admin', 'global_engineer', 'regional_engineer', 'project_engineer', 'regional_general_manager', 'district_engineer', 'district_manager']), async (req, res) => {
  try {
...
router.put('/:id', requireRole(['system_admin', 'global_engineer', 'regional_engineer', 'project_engineer', 'regional_general_manager', 'district_engineer', 'district_manager']), async (req, res) => {
  try {
    // TODO: Implement region/district checks as per Firestore rules
    const { id } = req.params;
