...
const PendingApprovalPage = lazyLoadRoute(() => import("./pages/PendingApprovalPage"), "Loading pending approval page...");
                ...
                <AudioProvider>
                  <TooltipProvider>
                    ...
                    <Routes>
                      ...
                      <Route path="/test/data-debug" element={<DataDebugPage />} />

                      <Route path="/test/vit" element={<VITTestPage />} />
