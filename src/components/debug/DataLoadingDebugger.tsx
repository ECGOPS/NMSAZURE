...
export function DataLoadingDebugger() {
  ...
  const handleClearVITCache = async () => {
    try {
      ...
      console.log('VIT assets cache cleared');
  ...
  const vitAssetsStatus = getDataStatus(vitAssets, 'VIT Assets');
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <div className="text-sm space-y-1">
              ...
              <p><strong>Region:</strong> {user?.region || 'Not assigned'}</p>
              <p><strong>District:</strong> {user?.district || 'Not assigned'}</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span>VIT Assets: {vitAssets?.length || 0} items</span>
