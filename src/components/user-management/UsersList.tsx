    ...
    <div className="space-y-6">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Badge variant="secondary" className="bg-yellow-100 text-yellow-800">
              {users.filter(user => user.status === 'pre_registered' || user.role === 'pending').length} pending
            </Badge>
          </div>
          ...
          <div className="space-y-2">
            {users
              .filter(user => user.status === 'pre_registered' || user.role === 'pending')
            ...
            {users.filter(user => user.status === 'pre_registered' || user.role === 'pending').length > 3 && (
      ...
      <div className="flex justify-center mb-4">
        <div className="inline-flex gap-3">
          ...
          <div className="bg-yellow-100 rounded-md px-4 py-2">
            <div className="flex flex-col items-center">
