...
export default function VITDebugPage() {
  ...
  const handleRefresh = async () => {
    console.log('[VITDebugPage] 🔄 Manually refreshing VIT assets...');
      ...
      <div className="container py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <strong>VIT Assets:</strong> {debugInfo.data?.vitAssetsCount || 0}
              </div>
              <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>First 3 VIT assets</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
          ...
          <CardContent>
            <div className="bg-muted p-4 rounded text-sm font-mono">
              ...
              <div className="mt-2 text-muted-foreground">
                • [DataContext] - VIT assets loading and filtering<br/>
